...
export default function HomeScreen() {
  ...
  const recommended = selectedCategory === "all"
    ? destinations
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.background }} edges={["top"]}>
      ...
      >
        ...
        <View style={{ marginTop: 28 }}>
          ...
          >
            ...
            <TouchableOpacity onPress={() => router.push("/(tabs)/explore")}>
              <Text style={{ fontSize: 13, fontFamily: "Poppins_500Medium", color: Colors.primary }}>
                Ver todos
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={{ marginTop: 28, paddingHorizontal: 24 }}>
          <Text style={{ fontSize: 18, fontFamily: "Poppins_700Bold", color: Colors.textPrimary, marginBottom: 16 }}>
            {selectedCategory === "all" ? "Todos los destinos" : selectedCategory}
          </Text>
