    ...
    >
      ...
      >
        ...
        <View style={{ padding: 12 }}>
          <Text
            style={{ fontSize: 14, fontFamily: "Poppins_600SemiBold", color: Colors.textPrimary, marginBottom: 4 }}
            numberOfLines={1}
          >
            {item.title}
          </Text>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 8 }}>
            ...
            <Text
              style={{ fontSize: 11, fontFamily: "Poppins_400Regular", color: Colors.textSecondary }}
              numberOfLines={1}
            >
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.background }} edges={["top"]}>
      ...
      <View style={{ paddingHorizontal: 24, paddingTop: 20, paddingBottom: 16 }}>
        <Text style={{ fontSize: 24, fontFamily: "Poppins_700Bold", color: Colors.textPrimary, marginBottom: 16 }}>
          Explorar
        </Text>
        <SearchBar
        ...
        <FlatList
          ...
          ListEmptyComponent={() => (
            <View style={{ alignItems: "center", paddingTop: 60, gap: 12 }}>
              ...
              <Text style={{ fontSize: 14, fontFamily: "Poppins_400Regular", color: Colors.textSecondary, textAlign: "center" }}>
